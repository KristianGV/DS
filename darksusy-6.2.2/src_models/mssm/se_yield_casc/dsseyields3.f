...
c------------------------ functions ------------------------------------
      ...
      real*8 dsseyields4,dsseemean,dsseyieldfth
...
c..."complex" channels
     ...
     &      3,wh,kind,type,istat,seerror)
        ...
        if (ans0br(7,hno).gt.0.0d0) then    ! S+ S- channel
          ...
          yield=yield+2.0*
     &      ans0br(7,hno)*dsseyields4(e1,emuth,thmax,4,wh,
     ...
     &      9,wh,kind,type,istat,seerror)
          yield=yield+ans0br(8,hno)*dsseyields4(e2,emuth,thmax,
     &      1,wh,kind,type,istat,seerror)
        endif
     ...
     &      9,wh,kind,type,istat,seerror)
          yield=yield+ans0br(9,hno)*dsseyields4(e2,emuth,thmax,
     &      2,wh,kind,type,istat,seerror)
        endif
     ...
     &      9,wh,kind,type,istat,seerror)
          yield=yield+ans0br(10,hno)*dsseyields4(e2,emuth,thmax,
     &      3,wh,kind,type,istat,seerror)
        endif
     ...
     &      8,wh,kind,type,istat,seerror)
          yield=yield+ans0br(11,hno)*dsseyields4(e2,emuth,thmax,
...
c---------- charged scalar bosons ----------
     ...
     &    8,wh,kind,type,istat,seerror)
          ...
          yield=yield+anscbr(13)*
     &      dsseyields4(e2,emuth,thmax,1,wh,kind,type,istat,seerror)
        endif
     ...
     &    8,wh,kind,type,istat,seerror)
          ...
          yield=yield+anscbr(14)*
     &      dsseyields4(e2,emuth,thmax,2,wh,kind,type,istat,seerror)
        endif
     ...
     &    8,wh,kind,type,istat,seerror)
          ...
          yield=yield+anscbr(15)*
     &      dsseyields4(e2,emuth,thmax,3,wh,kind,type,istat,seerror)
        endif
