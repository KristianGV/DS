...
c------------------------ functions ------------------------------------
      ...
      real*8 dsanyields3,dsanemean,dsanyieldfth,dsanyielddec
...
c..."complex" channels
     ...
     &      3,yieldk,istat)
        ...
        if (ans0br(7,hno).gt.0.0d0) then    ! S+ S- channel
          ...
          yield=yield+2.0*
     &      ans0br(7,hno)*dsanyields3(e1,egev,4,yieldk,istat)
        endif
     ...
     &       ans0m(1),egev,9,yieldk,istat)
          yield=yield+ans0br(8,hno)*dsanyields3(e2,egev,1,yieldk,istat)
        endif
     ...
     &       ans0m(2),egev,9,yieldk,istat)
          yield=yield+ans0br(9,hno)*dsanyields3(e2,egev,2,yieldk,istat)
        endif
     ...
     &       ans0m(3),egev,9,yieldk,istat)
          yield=yield
     &       +ans0br(10,hno)*dsanyields3(e2,egev,3,yieldk,istat)
        endif
     ...
     +    dsanyieldfth(eh,ans0m(hno),msim(8),anscm,egev,8,yieldk,istat)
          yield=yield
     &      +ans0br(11,hno)*dsanyields3(e2,egev,4,yieldk,istat)
        endif
...
c---------- charged scalar bosons ----------
     ...
     &    8,yieldk,istat)
          ...
          yield=yield+anscbr(13)*
     &      dsanyields3(e2,egev,1,yieldk,istat)
        endif
     ...
     &    8,yieldk,istat)
          ...
          yield=yield+anscbr(14)*
     &      dsanyields3(e2,egev,2,yieldk,istat)
        endif
     ...
     &    8,yieldk,istat)
          ...
          yield=yield+anscbr(15)*
     &      dsanyields3(e2,egev,3,yieldk,istat)
        endif
