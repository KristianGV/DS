...
c----------------------------------------------------------------------
c      write(*,*) 'dsanyield_int called with:'
c      write(*,*) '  a = ',a
c      write(*,*) '  b = ',b
      dsanyield_int=0.d0
      del=bb-aa
...
c        type *,'jdid',jdid,' os',os, 'ost',ost
      ...
      if (prtlevel.gt.0) then
        write(*,*) 'error in dsanyield_int: too many steps for model',
     &    idtag
        write(*,*) '  requested yield: ',phifk
        write(*,*) '  requested energy: ',phieth
        write(*,*) '  scalar number = ',phihno
        write(*,*) '  scalar mass = ',ans0m(phihno)
        write(*,*) '    or if called from dsanyieldfth, mh= ' ,phim0
        write(*,*) '    channel = ',phich
        write(*,*) '  higgs energy = ',phie0
        write(*,*) '  a = ',a
        write(*,*) '  b = ',b
        write(*,*) 'spectrum dumped to file haspec.dat'
        call dsanwspec(f,a,b,1000)
      endif
