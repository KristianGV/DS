...
c...  couplings
     ...
     - gr(kh3,kn(ineu),kn(1))
      CISR2 =Conjg(gl(sf,f,kn(1)))*gr(kh3,kn(ineu),kn(1))*
     - gr(sf,f,kn(ineu))
      CISR3 = Conjg(gr(sf,f,kn(1)))*gl(sf,f,kn(ineu))*
     - gr(kh3,kn(ineu),kn(1))
      CISR4 =Conjg(gr(sf,f,kn(1)))*gr(kh3,kn(ineu),kn(1))*
     - gr(sf,f,kn(ineu))
      CISR5 = Conjg(gl(sf,f,kn(1)))*Conjg(gr(kh3,kn(ineu),kn(1)))*
     - gl(sf,f,kn(ineu))
      CISR6 = Conjg(gl(sf,f,kn(1)))*Conjg(gr(kh3,kn(ineu),kn(1)))*
     - gr(sf,f,kn(ineu))
      CISR7 = Conjg(gr(kh3,kn(ineu),kn(1)))*Conjg(gr(sf,f,kn(1)))*
     - gl(sf,f,kn(ineu))
      CISR8 =Conjg(gr(kh3,kn(ineu),kn(1)))*Conjg(gr(sf,f,kn(1)))*
     - gr(sf,f,kn(ineu))
...
c... Defines ISR1 and ISR2 amplitudes through their simmetry relations via q3 exchange and conjugation of couplings. Further internal simmetry in ISRx via q1 & q3 exchange.
      if (leg.eq.1) then
        ...
        write(*,*) 'ERROR: dsib2ffA0tuISR called with wrong value leg = ',leg
        return
      endif
