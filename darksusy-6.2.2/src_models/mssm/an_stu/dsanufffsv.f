...
****************************************************
     ...
     &   gr(kp3,kpk,kp2)*gl(kp4,kp1,kpk)
      ...
      aa(0,0,0,-1)=aa(0,0,0,-1)-(dsqrt(2.0d0)*(e2*gy2*ppl-(e3*gy2*ppl)
     . -(epl*gy2*pp)+gm2*mk*pmi-(gx2*kk*ppl))*wd(1,0,1)*du)
      aa(0,0,0,1)=aa(0,0,0,1)-(dsqrt(2.0d0)*(e2*gy2*ppl-(e3*gy2*ppl)-(
     . epl*gy2*pp)+gm2*mk*pmi+gx2*kk*ppl)*wd(1,0,-1)*du)
      aa(1,-1,0,-1)=aa(1,-1,0,-1)+dsqrt(2.0d0)*((e2-e3)*(emi*gx2-(gy2*
     . pmi))-((emi*gy2-(gx2*pmi))*(kk-pp))+epl*gp2*mk-(gm2*mk*ppl))*wd
     . (1,-1,1)*du
      aa(1,-1,0,1)=aa(1,-1,0,1)+dsqrt(2.0d0)*((e2-e3)*(emi*gx2-(gy2*
     . pmi))+(emi*gy2-(gx2*pmi))*(kk+pp)+epl*gp2*mk-(gm2*mk*ppl))*wd(1
     . ,-1,-1)*du
      aa(1,0,0,-1)=aa(1,0,0,-1)+dsqrt(2.0d0)*(e2*epl*gx2-(e3*epl*gx2)+
     . emi*gp2*mk-(epl*gy2*kk)-(gx2*pp*ppl))*wd(1,0,1)*du
      aa(1,0,0,1)=aa(1,0,0,1)+dsqrt(2.0d0)*(e2*epl*gx2-(e3*epl*gx2)+
     . emi*gp2*mk+epl*gy2*kk-(gx2*pp*ppl))*wd(1,0,-1)*du
      aa(1,1,0,-1)=aa(1,1,0,-1)+dsqrt(2.0d0)*((e2-e3)*(emi*gx2+gy2*pmi
     . )-((emi*gy2+gx2*pmi)*(kk+pp))+epl*gp2*mk+gm2*mk*ppl)*wd(1,1,1)*
     . du
      aa(1,1,0,1)=aa(1,1,0,1)+dsqrt(2.0d0)*((e2-e3)*(emi*gx2+gy2*pmi)+
     . (emi*gy2+gx2*pmi)*(kk-pp)+epl*gp2*mk+gm2*mk*ppl)*wd(1,1,-1)*du
     ...
     . )*e4-(e2*e4*gy2*ppl)+e3*e4*gy2*ppl+gy2*kk**2*ppl)*wd(1,0,0)-((
     . e2*epl*gy2-(e3*epl*gy2)-(e4*epl*gy2)-(emi*gm2*mk)-(gy2*pp*ppl))
     . *kk))*du)/mp4
      aa(0,0,0,1)=aa(0,0,0,1)-(dsqrt(2.0d0)*(e2*gy2*ppl-(e3*gy2*ppl)-(
     . epl*gy2*pp)+gm2*mk*pmi+gx2*kk*ppl)*wd(1,0,-1)*du)
      aa(1,-1,0,-1)=aa(1,-1,0,-1)+dsqrt(2.0d0)*((e2-e3)*(emi*gx2-(gy2*
     . pmi))-((emi*gy2-(gx2*pmi))*(kk-pp))+epl*gp2*mk-(gm2*mk*ppl))*wd
     . (1,-1,1)*du
      aa(1,-1,0,0)=aa(1,-1,0,0)+(dsqrt(2.0d0)*((e2-e3)*(emi*gx2-(gy2*
     . pmi))*e4+(emi*gy2*pp+epl*gp2*mk-(gm2*mk*ppl)-(gx2*pmi*pp))*e4-(
     . emi*gx2*kk**2)+gy2*kk**2*pmi)*wd(1,-1,0)*du)/mp4
      aa(1,-1,0,1)=aa(1,-1,0,1)+dsqrt(2.0d0)*((e2-e3)*(emi*gx2-(gy2*
     . pmi))+(emi*gy2-(gx2*pmi))*(kk+pp)+epl*gp2*mk-(gm2*mk*ppl))*wd(1
     . ,-1,-1)*du
      aa(1,0,0,-1)=aa(1,0,0,-1)+dsqrt(2.0d0)*(e2*epl*gx2-(e3*epl*gx2)+
     ...
     . )*e4+e2*e4*epl*gx2-(e3*e4*epl*gx2)-(epl*gx2*kk**2))*wd(1,0,0)+
     . e2*gx2*kk*ppl-(e3*gx2*kk*ppl)-(e4*gx2*kk*ppl)-(epl*gx2*kk*pp)-(
     . gp2*kk*mk*pmi))*du)/mp4
      aa(1,0,0,1)=aa(1,0,0,1)+dsqrt(2.0d0)*(e2*epl*gx2-(e3*epl*gx2)+
     . emi*gp2*mk+epl*gy2*kk-(gx2*pp*ppl))*wd(1,0,-1)*du
      aa(1,1,0,-1)=aa(1,1,0,-1)+dsqrt(2.0d0)*((e2-e3)*(emi*gx2+gy2*pmi
     . )-((emi*gy2+gx2*pmi)*(kk+pp))+epl*gp2*mk+gm2*mk*ppl)*wd(1,1,1)*
     . du
      aa(1,1,0,0)=aa(1,1,0,0)+(dsqrt(2.0d0)*((e2-e3)*(emi*gx2+gy2*pmi)
     . *e4-((emi*gy2*pp-(epl*gp2*mk)-(gm2*mk*ppl)+gx2*pmi*pp)*e4)-(emi
     . *gx2*kk**2)-(gy2*kk**2*pmi))*wd(1,1,0)*du)/mp4
      aa(1,1,0,1)=aa(1,1,0,1)+dsqrt(2.0d0)*((e2-e3)*(emi*gx2+gy2*pmi)+
     . (emi*gy2+gx2*pmi)*(kk-pp)+epl*gp2*mk+gm2*mk*ppl)*wd(1,1,-1)*du
