...
*****************************************************************************
      ...
      real*8 function dsIBwhdxdy(IBch,x,y)
      ...
      integer IBch
      real*8 x,y,tmpresult,dssigmav0,msq2bodyds
      real*8 dsIBwhdxdy_1,dsIBwhdxdy_2,dsIBwhdxdy_3
      real*8 dsIBwhdxdy_4,dsIBwhdxdy_5,dsIBwhdxdy_6
      real*8 dsIBwhdxdy_7,dsIBwhdxdy_8,dsIBwhdxdy_9
...
c------------- couplings and masses relevant for IB -------------------
      ...
      complex*16 CHW11, CHW12, CHW21, CHW22, CHW3, 
...
c...constants separately, utilizing various symmetries
     ...
     -       *dsIBwhdxdy_1(x,y,m0,mw,mhc,mc1,mc2)
     -   + (abs(CHW11))**2
     -       *dsIBwhdxdy_1(x,y,m0,mw,mhc,mc1,mc1)
     -   + (abs(CHW12))**2
     -       *dsIBwhdxdy_1(x,y,m0,mw,mhc,mc2,mc2)
     -
     -   + 2*dble(CHW11*conjg(CHW22))
     -       *dsIBwhdxdy_2(x,y,m0,mw,mhc,mc1,mc2)
     -   + 2*dble(CHW11*conjg(CHW21))
     -       *dsIBwhdxdy_2(x,y,m0,mw,mhc,mc1,mc1)
     -   + 2*dble(CHW12*conjg(CHW22))
     -       *dsIBwhdxdy_2(x,y,m0,mw,mhc,mc2,mc2)
     -   + 2*dble(CHW12*conjg(CHW21))
     -       *dsIBwhdxdy_2(x,y,m0,mw,mhc,mc2,mc1)
     - 
     -   + 2*dble(CHW11*conjg(CHW3))
     -       *dsIBwhdxdy_3(x,y,m0,mw,mhc,mc1)
     -   + 2*dble(CHW12*conjg(CHW3))
     -       *dsIBwhdxdy_3(x,y,m0,mw,mhc,mc2)
     -
     -   + 2*dble(CHW21*conjg(CHW22))
     -       *dsIBwhdxdy_4(x,y,m0,mw,mhc,mc1,mc2)
     -   + (abs(CHW21))**2
     -       *dsIBwhdxdy_4(x,y,m0,mw,mhc,mc1,mc1)
     -   + (abs(CHW22))**2
     -       *dsIBwhdxdy_4(x,y,m0,mw,mhc,mc2,mc2)
     -
     -   + 2*dble(CHW21*conjg(CHW3))
     -       *dsIBwhdxdy_5(x,y,m0,mw,mhc,mc1)
     -   + 2*dble(CHW22*conjg(CHW3))
     -       *dsIBwhdxdy_5(x,y,m0,mw,mhc,mc2)
     -
     -   + (abs(CHW3))**2*dsIBwhdxdy_6(x,y,m0,mw,mhc)
     -
     -   + 2*dble(CHWA11*conjg(CHWA12))
     -       *dsIBwhdxdy_7(x,y,m0,mw,mhc,mc1,mc2)
     -   + (abs(CHWA11))**2
     -       *dsIBwhdxdy_7(x,y,m0,mw,mhc,mc1,mc1)
     -   + (abs(CHWA12))**2
     -       *dsIBwhdxdy_7(x,y,m0,mw,mhc,mc2,mc2)
     -
     -   + 2*dble(CHWA21*conjg(CHWA22))
     -       *dsIBwhdxdy_8(x,y,m0,mw,mhc,mc1,mc2)
     -   + (abs(CHWA21))**2
     -       *dsIBwhdxdy_8(x,y,m0,mw,mhc,mc1,mc1)
     -   + (abs(CHWA22))**2
     -       *dsIBwhdxdy_8(x,y,m0,mw,mhc,mc2,mc2)
     -
     -   + 2*dble(CHWA11*conjg(CHWA22))
     -       *dsIBwhdxdy_9(x,y,m0,mw,mhc,mc1,mc2)
     -   + 2*dble(CHWA11*conjg(CHWA21))
     -       *dsIBwhdxdy_9(x,y,m0,mw,mhc,mc1,mc1)
     -   + 2*dble(CHWA12*conjg(CHWA22))
     -       *dsIBwhdxdy_9(x,y,m0,mw,mhc,mc2,mc2)
     -   + 2*dble(CHWA12*conjg(CHWA21))
     -       *dsIBwhdxdy_9(x,y,m0,mw,mhc,mc2,mc1)


c... Since the branching ratios were calculated with dssigmav0, do
c... the same for the photon multiplicity for consistency.

      msq2bodyds=dssigmav0(24,-37)*32*pi*m0**2/gev2cm3s/
