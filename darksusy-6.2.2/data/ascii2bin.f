...
*** Updated 2017-04-19 to allow for 200 energy bins instead of 50.      
*****************************************************************************
...
c      parameter(nhead=44) ! number of header lines to remove (WimpSim 3.01)
      parameter(nhead=50) ! number of header lines to remove (WimpSim 3.03-4.0)
...
C----------------------------------------- Set-up common block variables
      ...
      write(*,*)
      write(*,*) '***************************************************'
      write(*,*) '*** Welcome to ascii2bin 3.3 (Apr 19, 2017)     ***'
