...
c
      external func, func2
      real*8 a,b,epsin,epsout,bound,func,func2
c
c     internal arrays
c
...
c...JE correction: to compile on gfortran
...
c
      alf=half*(b-a)
      bet=half*(b+a)
      const1=func(func2,a)+func(func2,b)
      const2=func(func2,bet)
      hnstep=two
...
c
      ...
      xplus=alf*alfnj+bet
      xmin=-alf*alfnj+bet
      umid=umid+func(func2,xplus)+func(func2,xmin)
      alfnj=alfnj+hnstep
50    continue
      umid=hnstep*umid
      goto 100
...
c
      ...
      xplus=alf*alfnj+bet
      xmin=-alf*alfnj+bet
      ccof(j)=func(func2,xplus)+func(func2,xmin)
      const1=alfnj
      const2=betnj
70    continue
c
