...
!     * the sum over m is done by FFT
  !=======================================================================
  subroutine alm2map_sc_d(nsmax, nlmax, nmmax, alm, map)
    !=======================================================================
    !     computes a map form its alm for the HEALPIX pixelisation
...
#ifdef USE_SHARP
    call sharp_hp_alm2map_x_d(nsmax,nlmax,nmmax,alm,map)
#else
...
!$OMP end parallel
    ...
    return
#endif
  end subroutine alm2map_sc_d

  !=======================================================================
  subroutine alm2map_spin_d(nsmax, nlmax, nmmax, spin, alm, map)
    !=======================================================================
    !     computes a map form its alm for the HEALPIX pixelisation
    !      for the Temperature field
    !=======================================================================
    integer(I4B),   intent(IN)                   :: nsmax, nlmax, nmmax, spin
    complex(DPC), intent(IN),  dimension(1:,0:,0:) :: alm
    ...
    if ((aspin>0).and.(aspin<=100)) then
      call sharp_hp_alm2map_spin_x_d(nsmax,nlmax,nmmax,aspin, &
    ...
    call init_rescale()
    map = 0.0_DP ! set the whole map to zero
...
!     integer(I4B), intent(IN)                   :: nsmax, nlmax, nmmax
!     complex(DPC), intent(IN),  dimension(1:1,0:nlmax,0:nmmax) :: alm
!     real(DP),   intent(OUT), dimension(    0:12*nsmax**2-1) :: map
...
!   end subroutine alm2map_sc_d
  ...
  !=======================================================================
  subroutine alm2map_sc_pre_d(nsmax, nlmax, nmmax, alm, map, plm)
    !=======================================================================
    !     computes a map form its alm for the HEALPIX pixelisation
...
!$OMP end parallel
    ...
    deallocate(b_north, b_south)
    return
  end subroutine alm2map_sc_pre_d

  !=======================================================================
  subroutine alm2map_pol_d(nsmax, nlmax, nmmax, alm_TGC, map_TQU)
    !=======================================================================
    !     computes a map form its alm for the HEALPIX pixelisation
    !      for the Temperature+Polarization field
    !=======================================================================
    integer(I4B), intent(IN)                   :: nsmax, nlmax, nmmax
    complex(DPC), intent(IN),  dimension(1:3,0:nlmax,0:nmmax) :: alm_TGC
    real(DP),   intent(OUT), dimension(0:(12_i8b*nsmax)*nsmax-1,1:3) :: map_TQU

#ifdef USE_SHARP
    call sharp_hp_alm2map_pol_x_d(nsmax,nlmax,nmmax,alm_TGC,map_TQU)
#else
...
!     integer(I4B), intent(IN)                   :: nsmax, nlmax, nmmax
!     complex(DPC), intent(IN),  dimension(1:3,0:nlmax,0:nmmax) :: alm_TGC
!     real(DP),   intent(OUT), dimension(0:12*nsmax**2-1,1:3) :: map_TQU
...
!   end subroutine alm2map_pol_d
  ...
  !=======================================================================
  subroutine alm2map_pol_pre1_d(nsmax, nlmax, nmmax, alm_TGC, map_TQU, plm)
    !=======================================================================
    !     computes a map form its alm for the HEALPIX pixelisation
    !      for the Temperature+Polarization field
    !=======================================================================
...
!$OMP end parallel
    ...
    deallocate(b_TQU)
    return
  end subroutine alm2map_pol_pre1_d

  !=======================================================================
  subroutine alm2map_pol_pre2_d(nsmax, nlmax, nmmax, alm_TGC, map_TQU, plm)
    !=======================================================================
    !     computes a map form its alm for the HEALPIX pixelisation
    !      for the Temperature+Polarization field
    !=======================================================================
...
!$OMP end parallel
    ...
    deallocate(b_TQU)
    return
  end subroutine alm2map_pol_pre2_d


  !=======================================================================
  subroutine alm2map_sc_der_d(nsmax, nlmax, nmmax, alm, map, der1, der2)
    !=======================================================================
    ...
    complex(DPC), INTENT(IN),  dimension(1:1,0:nlmax,0:nmmax) :: alm
    real(DP),   INTENT(OUT), dimension(0:(12_i8b*nsmax)*nsmax-1)     :: map
    real(DP),   INTENT(OUT), dimension(0:(12_i8b*nsmax)*nsmax-1,1:2) :: der1
    real(DP),   INTENT(OUT), dimension(0:(12_i8b*nsmax)*nsmax-1,1:3), optional :: der2
...
!$OMP end parallel
    ...
    return
  end subroutine alm2map_sc_der_d

  !=======================================================================
  subroutine alm2map_pol_der_d(nsmax, nlmax, nmmax, alm_TGC, map_TQU, der1, der2)
    !=======================================================================
    !     computes a map and its 1st and 2nd derivative 
    !       from its alm for the HEALPIX pixelisation
    ...
    complex(DPC), INTENT(IN),  dimension(1:3,0:nlmax,0:nmmax) :: alm_TGC
    real(DP),   INTENT(OUT), dimension(0:(12_i8b*nsmax)*nsmax-1,1:3)     :: map_TQU
    real(DP),   INTENT(OUT), dimension(0:(12_i8b*nsmax)*nsmax-1,1:6) :: der1
    real(DP),   INTENT(OUT), dimension(0:(12_i8b*nsmax)*nsmax-1,1:9), optional :: der2
...
!$OMP end parallel
    ...
    return
  end subroutine alm2map_pol_der_d
  ...
  !=======================================================================
  subroutine map2alm_old_sc_d(nsmax, nlmax, nmmax, map, alm, cos_theta_cut, w8ring, plm)
    !=======================================================================
    integer(I4B), intent(IN)                    :: nsmax, nlmax, nmmax
    ...
    return
  end subroutine map2alm_old_sc_d
  !=======================================================================
  subroutine map2alm_old_pol_d(nsmax, nlmax, nmmax, map_TQU, alm_TGC, cos_theta_cut, w8ring, plm)
    !=======================================================================
    integer(I4B), intent(IN)                    :: nsmax, nlmax, nmmax
    real(DP),   intent(IN),  dimension(0:(12_i8b*nsmax)*nsmax-1,1:3) :: map_TQU
    complex(DPC), intent(OUT), dimension(1:3,0:nlmax,0:nmmax) :: alm_TGC
    real(DP),     intent(IN)                          :: cos_theta_cut
    ...
    return
  end subroutine map2alm_old_pol_d

  !=======================================================================
  subroutine map2alm_old_pol2_d(nsmax, nlmax, nmmax, map_TQU, alm_TGC, cos_theta_cut, w8ring, plm)
    !=======================================================================
    integer(I4B), intent(IN)                    :: nsmax, nlmax, nmmax
    real(DP),   intent(IN),  dimension(0:(12_i8b*nsmax)*nsmax-1,1:3) :: map_TQU
    complex(DPC), intent(OUT), dimension(1:3,0:nlmax,0:nmmax) :: alm_TGC
    ...
    return
  end subroutine map2alm_old_pol2_d

!   !=======================================================================
!   subroutine map2alm_sc_test_d(nsmax, nlmax, nmmax, map, alm, zbounds, w8ring)
!     !=======================================================================
!     !     computes the a(l,m) from a Temperature map for the HEALPIX pixelisation
!     !        all from scratch
!     !=======================================================================
!     integer(I4B), intent(IN)                    :: nsmax, nlmax, nmmax
!     real(DP),   intent(IN),  dimension(    0:12*nsmax**2-1) :: map
!     complex(DPC), intent(OUT), dimension(1:1,0:nlmax,0:nmmax) :: alm
...
!     endif
!     RETURN
!   END subroutine map2alm_sc_test_d

  !=======================================================================
  subroutine map2alm_sc_d(nsmax, nlmax, nmmax, map, alm, zbounds, w8ring)
    !=======================================================================
    !     computes the a(l,m) from a Temperature map for the HEALPIX pixelisation
    !        all from scratch
    !=======================================================================
    ...
    call sharp_hp_map2alm_x_d(nsmax,nlmax,nmmax,map,alm,zbounds_in,w8ring_in)
#else
...
!$OMP end parallel
  ...
  subroutine map2alm_spin_d(nsmax, nlmax, nmmax, spin, map, alm, zbounds, w8ring)
    ...
    complex(DPC), intent(OUT), dimension(1:,0:,0:) :: alm
    real(DP),       intent(IN),  dimension(1:2),         optional :: zbounds
    ...
    aspin = abs(spin)
    if ((aspin>0).and.(aspin<=100)) then
      call sharp_hp_map2alm_spin_x_d(nsmax,nlmax,nmmax,aspin, &
...
!$OMP end parallel
    ...
    RETURN
  END subroutine map2alm_spin_d

  !=======================================================================
  subroutine map2alm_sc_pre_d(nsmax, nlmax, nmmax, map, alm, zbounds, w8ring, plm)
    !=======================================================================
    !     computes the a(l,m) from a Temperature map for the HEALPIX pixelisation
...
!$OMP end parallel
    ...
    deallocate(phas_n,phas_s)
    RETURN
  END subroutine map2alm_sc_pre_d


!   !=======================================================================
!   subroutine map2alm_pol_test_d(nsmax, nlmax, nmmax, map_TQU,&
...
!     !=======================================================================
!     integer(I4B), intent(IN)                   :: nsmax, nlmax, nmmax
!     real(DP),   intent(IN),  dimension(0:12*nsmax**2-1,1:3) :: map_TQU
!     complex(DPC), intent(OUT), dimension(1:3,0:nlmax,0:nmmax) :: alm_TGC
!     real(DP),     intent(IN),  dimension(1:2)                 :: zbounds
...
!     deallocate(phas_ns)
!     return
!   end subroutine map2alm_pol_test_d

  !=======================================================================
  subroutine map2alm_pol_d(nsmax, nlmax, nmmax, map_TQU,&
       &                     alm_TGC, zbounds, w8ring_TQU)
    !=======================================================================
    !     computes the a(l,m) from a polarized map for the HEALPIX pixelisation
    !       all from scratch
    ...
    call sharp_hp_map2alm_pol_x_d(nsmax,nlmax,nmmax,map_TQU,alm_TGC,zbounds_in,w8ring_in)
#else
...
!    print*,'FFT',tt1
    ...
    return
#endif
  end subroutine map2alm_pol_d

  !=======================================================================
  subroutine map2alm_pol_pre1_d(nsmax, nlmax, nmmax, map_TQU,&
...
!    print*,'FFT',tt1
    ...
    return
  end subroutine map2alm_pol_pre1_d

  !=======================================================================
  subroutine map2alm_pol_pre2_d(nsmax, nlmax, nmmax, map_TQU,&
       &                     alm_TGC, zbounds, w8ring_TQU, plm)
    !=======================================================================
    !     computes the a(l,m) from a polarized map for the HEALPIX pixelisation
...
!$OMP end parallel
    ...
    return
  end subroutine map2alm_pol_pre2_d


  !=======================================================================
  subroutine map2alm_iterative_d(nsmax, nlmax, nmmax, iter_order, map_TQU, alm_TGC, &
  ...
  !=======================================================================
    ...
    real(DP),     intent(INOUT),  dimension(0:,1:), target    :: map_TQU
    complex(DPC), intent(INOUT), dimension(1:,0:,0:) :: alm_TGC
    real(DP),       intent(IN),  dimension(1:2),    optional :: zbounds
    real(DP),       intent(IN),  dimension(1:,1:), optional :: w8ring
    real(DP),       intent(IN),  dimension(0:,1:), optional, target :: plm
    real(DP),     intent(IN),  dimension(0:,1:),   optional :: mask
    ! local variables
    real(DP), dimension(1:2)         :: zbounds_in
    real(DP), dimension(1:2*nsmax,3) :: w8ring_in
    ...
    real(DP),     allocatable, dimension(:,:)   :: map_TQU_in
    complex(DPC),allocatable,  dimension(:,:,:) :: alm_TGC_out

    character(len=*), parameter :: code = 'map2alm_iterative'
    real(DP), pointer, dimension(:) :: p_map_1
    ...
    if (iter_order > 0) then
       ...
       alm_TGC_out = 0.0_DPC      ! final alm
       map_TQU_in  = map_TQU        ! input map (masked)
       alm_TGC     = 0.0_DPC      ! intermediate alm
    endif
...
9111   format(i3,3(g20.5))
    ...
    return
  end subroutine map2alm_iterative_d
  ...
  !=======================================================================
  subroutine alter_alm_d(nsmax, nlmax, nmmax, fwhm_arcmin, alm, beam_file, window)
    !=======================================================================
    ...
    if (present(window)) then
       ...
       if (nlw <= nlmax) then
          alm(1:nda, nlw:nlmax, 0:nmmax) = 0.0_DPC
    ...
    return
  end subroutine alter_alm_d

  !=======================================================================
  subroutine create_alm_v12_d &
    ...
    return
  end subroutine create_alm_v12_d
   !=======================================================================
  subroutine create_alm_old_d &
       &     (nsmax, nlmax, nmmax, polar, filename, rng_handle, fwhm_arcmin, &
       &        alm_TGC, header_PS, windowfile, units, beam_file)
    !=======================================================================
...
!    REAL(DP), DIMENSION(:),   ALLOCATABLE :: fact_norm
    ...
    if (polarisation) then
       alm_TGC(1:3, 0:nlmax, 0:nmmax) = CMPLX(0.0,0.0, kind=DP)
    else
       alm_TGC(1  , 0:nlmax, 0:nmmax) = CMPLX(0.0,0.0, kind=DP)
    endif
    !     --------------------------------------
    cls_tt = 0.0_dp
    cls_gg = 0.0_dp
...
!        zeta1_r = randgauss_boxmuller(iseed)  ! gaussian deviate based on ran_mwc
       ...
       zeta1_i = 0.0_dp
       alm_TGC(1, l, 0)   = CMPLX(zeta1_r, zeta1_i, kind=DP) * rms_tt ! T
       if (polarisation) then
...
!          zeta1_i = randgauss_boxmuller(iseed) * hsqrt2
          ...
          alm_TGC(1, l, m) = CMPLX(zeta1_r, zeta1_i, kind=DP) * rms_tt
          if (polarisation) then
...
!          zeta3_r = randgauss_boxmuller(iseed)
          ...
          alm_TGC(2, l, 0) = alm_TGC(2, l, 0) &
               &           + CMPLX(zeta2_r, zeta2_i, kind=DP) * rms_g2 ! G
          alm_TGC(3, l, 0) = CMPLX(zeta3_r, zeta3_i, kind=DP) * rms_cc ! C
...
!              zeta3_i = randgauss_boxmuller(iseed) * hsqrt2
             ...
             alm_TGC(2, l, m) = alm_TGC(2, l, m) &
                  &                 + CMPLX(zeta2_r, zeta2_i, kind=DP) * rms_g2 ! G
             alm_TGC(3, l, m) = CMPLX(zeta3_r, zeta3_i, kind=DP) * rms_cc ! C
          enddo
       enddo
    endif

    return
  end subroutine create_alm_old_d

   !=======================================================================
  subroutine create_alm_d &
       &     (nsmax, nlmax, nmmax, polar, filename, rng_handle, fwhm_arcmin, &
       &        alm_TGC, header_PS, windowfile, units, beam_file)
    !=======================================================================
    !     creates the a_lm from the power spectrum,
...
!     call gaussbeam(real(fwhm_arcmin,kind=dp), l_max, beamw)
    ...
    do l = 0, l_max
       ...
       zeta1_r = rand_gauss(rng_handle)
       zeta1_i = ZERO
       zeta1   = CMPLX(zeta1_r, zeta1_i, kind=DP)
    ...
    if (polarisation) then
       do l = 0, l_max
          ...
          zeta3_r = rand_gauss(rng_handle)
          zeta3_i = ZERO
          zeta2   = CMPLX(zeta2_r, zeta2_i, kind=DP)
          zeta3   = CMPLX(zeta3_r, zeta3_i, kind=DP)
    ...
    return
  end subroutine create_alm_d

  !========================================================
  subroutine sub_alm2cl_d(alm1, i1, alm2, i2, cl, i3)
    !========================================================
    integer(I4B),                        intent(in) :: i1, i2, i3
    complex(DPC), dimension(1:,0:,0:), intent(in) :: alm1, alm2
    ...
    return
  end subroutine sub_alm2cl_d
  !========================================================
  subroutine alm2cl2_d(nlmax, nmmax, alm1, alm2, cl, symmetric)
  !========================================================
    ...
    return
  end subroutine alm2cl2_d
  !========================================================
  subroutine alm2cl1_d(nlmax, nmmax, alm1, cl)
  !========================================================
    ! computes C(l) from a_lm, in the order
    ! TT, [EE, TE, BB, [TB, EB]]
    !=======================================================
    integer(I4B),                      intent(in) :: nlmax, nmmax
    complex(DPC), dimension(1:,0:,0:), intent(in) :: alm1
    real(DP)    , dimension(0:, 1: ),  intent(out):: cl
    ! 
    integer(I4B) :: ncl
    !========================================================
...
!$OMP end parallel
  ...
  !**************************************************************************
  !==============================================================================
  subroutine sub_map2ring_1d_d(map, start_pix, np_in_ring, weight, ring, partial, pixels)
    !==============================================================================
    ...
    !==============================================================================    
    real(DP),   intent(IN),  dimension(0:)     :: map
  ...
  end subroutine sub_map2ring_1d_d
  !==============================================================================
  subroutine sub_map2ring_nd_d(map, idim, start_pix, np_in_ring, weight, ring, partial, pixels)
    !==============================================================================
  ...
  end subroutine sub_map2ring_nd_d

  !==============================================================================
  subroutine sub_ring2map_1d_d(ring, map, start_pix, np_in_ring, partial, pixels)
    !==============================================================================
    ...
    real(DP),   intent(OUT), dimension(0:)     :: map
    integer(I8B), intent(IN)                     :: start_pix
    integer(I4B), intent(IN)                     :: np_in_ring
    logical(LGT), intent(IN),                 optional :: partial
    integer(I8B), intent(IN),  dimension(0:), optional :: pixels
  ...
  end subroutine sub_ring2map_1d_d

  !==============================================================================
  subroutine sub_ring2map_nd_d(ring, map, idim, start_pix, np_in_ring, partial, pixels)
    !==============================================================================
  ...
  end subroutine sub_ring2map_nd_d
