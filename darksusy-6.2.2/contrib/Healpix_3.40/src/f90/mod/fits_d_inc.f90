...
!
!    subroutine input_map_d            (4/8)
!    subroutine read_bintab_d          (4/8)
!    subroutine read_conbintab_d           NotYet
!    subroutine write_bintab_d         (4/8)
!    subroutine write_asctab_d          NA
!    subroutine dump_alms_d                NotYet
!    subroutine write_alms_d               NotYet
!    subroutine read_alms_d                NotYet
!    subroutine read_bintod_d           (8)
!    subroutine write_bintabh_d         (8)
!    subroutine unfold_weights_d
!    subroutine unfold_weightslist_d
!
!
...
!=======================================================================
#ifndef NO64BITS
subroutine input_map4_d(filename, map, npixtot, nmaps, &
    ...
    npixtot8 = npixtot
    call input_map8_d(filename, map, npixtot8, nmaps, &
         fmissval, header, units, extno, ignore_polcconv)

    return
  end subroutine input_map4_d
#endif

!=======================================================================
subroutine input_map8_d(filename, map, npixtot, nmaps, &
     fmissval, header, units, extno, ignore_polcconv)
    !=======================================================================
...
9000 format(a)
  ...
  !=======================================================================
#ifndef NO64BITS
  subroutine read_bintab4_d(filename, map, npixtot, nmaps, nullval, anynull, header, units, extno)
    character(len=*),                          intent(IN)  :: filename
    integer(I4B),                              intent(IN)  :: npixtot
    integer(I4B),                              intent(IN)  :: nmaps
    ...
    call read_bintab8_d(filename, map, npixtot8, nmaps, nullval, anynull, header, units, extno)
    return

  end subroutine read_bintab4_d
#endif
  subroutine read_bintab8_d(filename, map, npixtot, nmaps, nullval, anynull, header, units, extno)
  !=======================================================================
    character(len=*),                          intent(IN)  :: filename
    integer(I8B),                              intent(IN)  :: npixtot
    integer(I4B),                              intent(IN)  :: nmaps
...
#ifndef NO64BITS
  subroutine write_bintab4_d(map, npix, nmap, header, nlheader, filename, extno)
  !=======================================================================
    ...
    if (present(extno)) then
       call write_bintab8_d(map, npix8, nmap, header, nlheader, filename, extno)
    else
       call write_bintab8_d(map, npix8, nmap, header, nlheader, filename)
    endif
    return
  end subroutine write_bintab4_d
#endif

  subroutine write_bintab8_d(map, npix, nmap, header, nlheader, filename, extno)
    !=======================================================================
...
!    character(len=80)         :: junk_k, junk_v, junk_c
    ...
    return
  end subroutine write_bintab8_d
  !=======================================================================
...
!                   & ') will be used.'
    ...
    if (lengap > 0) then
       ...
       if (DP == SP) padding(:) = HPX_SBADVAL
       if (DP == DP) padding(:) = HPX_DBADVAL
       do colnum = 1, ntod
...
! 2018-05-25
!---------------------------------------
  subroutine unfold_weightsfile_d(w8file, w8map)

    USE pix_tools,      only: nside2npix, nside2npweights

    character(len=*), intent(in)                  :: w8file
    real(DP),       intent(out), dimension(0:)  :: w8map
    real(DP),       allocatable, dimension(:,:) :: w8list
    ...
    return
  end subroutine unfold_weightsfile_d
!---------------------------------------
...
! 2018-05-18
!---------------------------------------
  subroutine unfold_weightslist_d(nside, won, w8list, w8map)

    USE pix_tools,      only: nside2npix, nside2npweights
    USE long_intrinsic, only: long_size

    integer(i4b),            intent(in)  :: nside, won
    real(DP), dimension(0:), intent(in)  :: w8list
    real(DP), dimension(0:), intent(out) :: w8map
    ...
    return
  end subroutine unfold_weightslist_d
