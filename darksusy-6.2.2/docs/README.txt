...
as a source for the pdf manual.
...
Eventual figures should be refered to as fig/<filename> and be put in
...
through latex  to create the pdf manual.

Questions?

Ask Joakim Edsjo, edsjo@fysik.su.se
