...
***********************************************************************
      ...
      real*8 mx,sigsi,ma
      real*8 mxx,max,sigsix,rmin,rmax,res,dssenu_ceint,rx,foveru,sigsdx
      integer imass(11),nmass,i,ix,vtype,vt
      external dssenu_ceint,foveru
...
c...begin radial integration
        ...
        call dssenu_hiprecint(dssenu_ceint,foveru,rmin,rmax,res)
        dssenu_capearthnumi=dssenu_capearthnumi+res
 10   continue
