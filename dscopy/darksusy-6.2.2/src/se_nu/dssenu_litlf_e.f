...
c=======================================================================
       ...
       implicit none
       include 'dsmpconst.h'
       real*8 mx,aa(11),dssenu_se,vbar,x,a
       real*8 m(11),f(11),phi(11),mn,dssea_ff(11)
       integer i
       mn=(m_p+m_n)/2.0d0
       m(1)=16.d0*mn
       m(2)=28.d0*mn
...
c...new full average
 ...
 10    continue
       ...
       dssea_ff(4)=1.d0-0.26d0*a/(1.d0+a)
...
c...Now calculate f, Eq. (9-28) in jkg
       do 20 i=1,11
         dssenu_litlf_e=dssenu_litlf_e+
     &   dssea_ff(i)*f(i)*phi(i)*dssenu_se(mx/m(i),vbar)
     &   *m(i)**3*mx/(mx+m(i))**2
 20    continue
       return
       end
