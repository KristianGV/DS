...
c...specifically the more general expressions in appendix A.
      ...
      real*8 r,ni,e0,sla1,sla2,sla3,v,dssem_earthvesc,
     &  dssem_earthdenscomp,foveru
      integer imass,vtype
      external foveru
      ...
      ni=dssem_earthdenscomp(r/100.0d0,imass) ! target number density in earth
...
c...over the energy loss (or q^2)
      ...
      dssenu_ceint2=foveru(u)*sla3*(sla1-sla2)  ! gould (A6) + (2.8)
c      write(*,*) 'u=',u,'  dssenu_ceint2=',dssenu_ceint2,sla3,sla1,sla2
c      write(*,*) 'foveru = ',foveru(u)
c...we have two factors of c missing, add them to get units cm^-4
      dssenu_ceint2=dssenu_ceint2*(3.0d10)**2
c...dssenu_ceint2 is now equal to f(u)/u * w Omega_v^-(w), i.e.
c...f(u)/u * (A6) in Gould.
