...
c
      ...
      oflow = d1mach(2)
      ierro = 0
      call dssenu_dqk21b(f,foveru,a,b,result,abserr,defabs,resabs)
c
c           test on accuracy.
c
      dres = dabs(result)
...
c
        ...
        b2 = blist(maxerr)
        erlast = errmax
        call dssenu_dqk21b(f,foveru,a1,b1,area1,error1,resabs,defab1)
        call dssenu_dqk21b(f,foveru,a2,b2,area2,error2,resabs,defab2)
c
