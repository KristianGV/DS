...
c
      double precision a,abserr,b,epsabs,epsrel,f,func2,points,result,work
...
c
      ...
      l4 = limit+l3
c
      call dqagpe2(f,func2,a,b,npts2,points,epsabs,epsrel,limit,result,abserr,
...
c      if(ier.ne.0) call xerror(26habnormal return from dqagp,26,ier,lvl)
      ...
      subroutine dqagpe2(f,func2,a,b,npts2,points,epsabs,epsrel,limit,result,
...
c***end prologue  dqagpe
     ...
     *  errmax,error1,erro12,error2,errsum,ertest,f,func2,oflow,points,pts,
...
c
   40 resabs = 0.0d+00
      do 50 i = 1,nint
        b1 = pts(i+1)
        call dqk212(f,func2,a1,b1,area1,error1,defabs,resa)
...
c
        ...
        b2 = blist(maxerr)
        erlast = errmax
        call dqk212(f,func2,a1,b1,area1,error1,resa,defab1)
        call dqk212(f,func2,a2,b2,area2,error2,resa,defab2)
c
