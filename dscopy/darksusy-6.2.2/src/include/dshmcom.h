*         -*- mode: fortran -*-
      real*8 rho0,v_sun,r_0,v_earth
      integer hclumpy   ! (1=smooth, 2=clumpy)

      common /dshmcom/rho0,v_sun,r_0,v_earth,hclumpy
...
c...Add this elsewhere later
     ...
     &  isodfload
      ...
      !Additional parameters for Einasato profile
      double precision rs_e,rhos_e,n_e
      common/einastoparcom/rs_e,rhos_e,n_e
...
c...Additional settings and parameters for Dark Disk
      real*8 v_lag_dd,vd_3d_dd,delta_dd
      logical include_dd
      common/hmdd/v_lag_dd,vd_3d_dd,delta_dd,include_dd

      save /dshmcom/,/dshmisodf/,/dshmnoclue/,/dshmcom2/,/albegaparcom/
     & ,/n03parcom/,/hmnumcom/,/hmnumcom2/,/hmboer/,/hmdd/
     & ,/einastoparcom/
