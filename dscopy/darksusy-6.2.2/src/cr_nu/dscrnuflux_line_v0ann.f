...
**********************************************************************
      ...
      crsrc(1) = dscrsource_line(12,n,2,0.d0,egev,widthline,pdg2,istat) ! nue at source
      crsrc(2) = dscrsource_line(14,n,2,0.d0,egev,widthline,pdg2,istat) ! numu at source
      crsrc(3) = dscrsource_line(16,n,2,0.d0,egev,widthline,pdg2,istat) ! nutau at source
      
      crosc = dscroscillation_simp(2,crsrc) ! numu at earth
      
      dscrnuflux_line_v0ann = crosc*jpsi*xi**2*kpc*1.d21/(4.d0*pi)
