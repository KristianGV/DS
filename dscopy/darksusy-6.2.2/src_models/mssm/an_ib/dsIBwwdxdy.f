...
*****************************************************************************
      ...
      real*8 dsIBwwdxdy_1,dsIBwwdxdy_2,dsIBwwdxdy_3
      real*8 dsIBwwdxdy_4,dsIBwwdxdy_5
...
c...constants separately, utilizing various symmetries
     ...
     -       *dsIBwwdxdy_1(x,y,m0,mw,mc1,mc2)
     -   + (Cllww1+Crrww1)**2/2.
     -       *dsIBwwdxdy_1(x,y,m0,mw,mc1,mc1)
     -   + (Cllww2+Crrww2)**2/2.
     -       *dsIBwwdxdy_1(x,y,m0,mw,mc2,mc2)
     - 
     -   + (Cllww1*Crrww2+Crrww1*Cllww2)
     -       *dsIBwwdxdy_2(x,y,m0,mw,mc1,mc2)
     -   + Cllww1*Crrww1*dsIBwwdxdy_2(x,y,m0,mw,mc1,mc1)
     -   + Cllww2*Crrww2*dsIBwwdxdy_2(x,y,m0,mw,mc2,mc2)
     -
     -   + (Cllww1 + Crrww1)*Clrww52
     -       *dsIBwwdxdy_3(x,y,m0,mw,mc1,mc2)
     -   + (Cllww2 + Crrww2)*Clrww51
     -       *dsIBwwdxdy_3(x,y,m0,mw,mc2,mc1)
     -   + (Cllww1 + Crrww1)*Clrww51
     -       *dsIBwwdxdy_3(x,y,m0,mw,mc1,mc1)
     -   + (Cllww2 + Crrww2)*Clrww52
     -       *dsIBwwdxdy_3(x,y,m0,mw,mc2,mc2)
     -
     -   + Clrww1*Clrww2*dsIBwwdxdy_4(x,y,m0,mw,mc1,mc2)
     -   + Clrww1*Clrww1*dsIBwwdxdy_4(x,y,m0,mw,mc1,mc1)/2.
     -   + Clrww2*Clrww2*dsIBwwdxdy_4(x,y,m0,mw,mc2,mc2)/2.
     -
     -   + Clrww51*Clrww52*dsIBwwdxdy_5(x,y,m0,mw,mc1,mc2)
     -   + Clrww51*Clrww51*dsIBwwdxdy_5(x,y,m0,mw,mc1,mc1)/2.
     -   + Clrww52*Clrww52*dsIBwwdxdy_5(x,y,m0,mw,mc2,mc2)/2.

c... Since the branching ratios were calculated with dssigmav0, do
c... the same for the photon multiplicity for consistency.

      msq2bodyds=dssigmav0(24,-24)*32*pi*m0**2/sqrt(1-mw**2/m0**2)/
     -           gev2cm3s
