     ...
     &  kp1,'(',pname(kp1),'), ',kp2,'(',pname(kp2),')'
      ...
      implicit none
      include 'dsmssm.h'
      logical dsissfermion, tmp
      integer kp,i
            
c      dsissfermion=kp.eq.ksnue.or.kp.eq.kse1.or.kp.eq.kse2.or.kp.eq.ksnumu
c     &    .or.kp.eq.ksmu1.or.kp.eq.ksmu2.or.kp.eq.ksnutau.or.kp.eq.kstau1
c     &    .or.kp.eq.kstau2.or.kp.eq.ksu1.or.kp.eq.ksu2.or.kp.eq.ksd1.or.
c     &    kp.eq.ksd2.or.kp.eq.ksc1.or.kp.eq.ksc2.or.kp.eq.kss1.or.
c     &    kp.eq.kss2.or.kp.eq.kst1.or.kp.eq.kst2.or.kp.eq.ksb1.or.kp.eq.ksb2

       tmp=.false.
       i=1
 10    tmp=tmp.or.kp.eq.ksnu(i).or.kp.eq.ksl(i)
     &          .or.kp.eq.ksqu(i).or.kp.eq.ksqd(i)
       i=i+1
       if (i.lt.7.and.(.not.tmp)) goto 10
       dsissfermion=tmp
      return
      end
