...
c=======================================================================
      ...
      integer unphys,valid,i,iallow,IMHL,IMHC,IMSQ
      real*8 mx
      real dssug(6)
      logical dsisnan
...
c... Calculate masses from last iteration
     ...
     $ dssug(6),iallow,1,IMHL,IMHC,IMSQ)
...
c      endif
      if (valid.gt.0) then
         ...
         unphys=ibset(unphys,8)  ! TB: Set bit 8 of unphys in that case
         return
      endif
...
c... set common blocks ksnu_flav, ksl_flav, ksqu_flav, ksqd_flav to allow
c... access to the dominant flavour of all sfermions
