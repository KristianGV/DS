...
c=======================================================================
      ...
      real*8 zgm,dsabsq,mwtmp
      integer i,j,g,valid
      complex*16 chaumxtmp(2,2),chavmxtmp(2,2)

      real*8 cotgl,cotgr,singl,singr,cosgl,cosgr
...
c======= stau mixing ===============
      sldlmx(3,3) = dcmplx(cos(mix_stau),0.d0)
      sldlmx(6,3) = dcmplx(-sin(mix_stau),0.d0)
      sldrmx(3,3) = dcmplx(sin(mix_stau),0.d0)
      sldrmx(6,3) = dcmplx(cos(mix_stau),0.d0)

c========= stop mixing ===========
      squlmx(3,3) = dcmplx(cos(mix_stop),0.d0)
      squlmx(6,3) = dcmplx(-sin(mix_stop),0.d0)
      squrmx(3,3) = dcmplx(sin(mix_stop),0.d0)
      squrmx(6,3) = dcmplx(cos(mix_stop),0.d0)

c======= sbottom mixing=========
      sqdlmx(3,3) = dcmplx(cos(mix_sbot),0.d0)
      sqdlmx(6,3) = dcmplx(-sin(mix_sbot),0.d0)
      sqdrmx(3,3) = dcmplx(sin(mix_sbot),0.d0)
      sqdrmx(6,3) = dcmplx(cos(mix_sbot),0.d0)
...
c...This addition is made by Joakim Edsjo, edsjo@fysik.su.se, 02-09-11
      mass2l(1)=gss(16)
      mass2e(1)=gss(15)
      mass2q(1)=gss(19)
      mass2u(1)=gss(18)
