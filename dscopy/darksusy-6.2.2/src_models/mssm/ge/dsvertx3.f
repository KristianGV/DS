...
c...... FIXME: temporary solution for Asoft (PG 2002-02-16)
      ...
      ae(2,2)=asofte(2)
      ae(3,3)=asofte(3)
c...... end of temporary solution for Asoft
c...... FIXME: temporary solution for running masses (PG 2002-06-16)
     ...
     &           aux*conjg(gmnell(k,l)))
      ...
      do k=1,3
         do l=1,3
            ...
            ! Z-Z-snu-snu, factor of two corrected, Mia Schelke (020903)
