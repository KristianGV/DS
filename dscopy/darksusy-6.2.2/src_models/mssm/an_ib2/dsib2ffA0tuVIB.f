...
c... couplings
      CVIB1 = Conjg(gl(sf(2),f,kn(1)))*gl(kh3,sf(1),sf(2))*
     - gl(sf(1),f,kn(1))
      CVIB2 =Conjg(gl(sf(2),f,kn(1)))*gl(kh3,sf(1),sf(2))*
     - gr(sf(1),f,kn(1))
      CVIB3 =Conjg(gr(sf(2),f,kn(1)))*gl(kh3,sf(1),sf(2))*
     - gl(sf(1),f,kn(1))
      CVIB4 =Conjg(gr(sf(2),f,kn(1)))*gl(kh3,sf(1),sf(2))*
     - gr(sf(1),f,kn(1))
