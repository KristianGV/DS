...
*******************************************************************
     ...
     & CCISR6, CCISR7, CCISR8
      ...
      ff   = c_fbartype
c      sff  = dsib2getsfermion(ff, isf)
c      Msff = mass(sff)/mx ! dimensionless in order to be consistent with kinematics
...
c... couplings
     ...
     -        Conjg(gr(kw,kn(1),kcha(icha)))*gl(sf,f,kn(1))
         CISR2 = Conjg(gr(kw,kn(1),kcha(icha)))*
     -        Conjg(gr(sf,ff,kcha(icha)))*gl(sf,f,kn(1))
         CISR3 = Conjg(gl(sf,ff,kcha(icha)))*
     -        Conjg(gr(kw,kn(1),kcha(icha)))*gr(sf,f,kn(1))
         CISR4 = Conjg(gr(kw,kn(1),kcha(icha)))*
     -        Conjg(gr(sf,ff,kcha(icha)))*gr(sf,f,kn(1))
         CISR5 = Conjg(gl(kw,kn(1),kcha(icha)))*
     -        Conjg(gl(sf,ff,kcha(icha)))*gl(sf,f,kn(1))
         CISR6 = Conjg(gl(kw,kn(1),kcha(icha)))*
     -        Conjg(gr(sf,ff,kcha(icha)))*gl(sf,f,kn(1))
         CISR7 = Conjg(gl(kw,kn(1),kcha(icha)))*
     -        Conjg(gl(sf,ff,kcha(icha)))*gr(sf,f,kn(1))
         CISR8 = Conjg(gl(kw,kn(1),kcha(icha)))*
     -        Conjg(gr(sf,ff,kcha(icha)))*gr(sf,f,kn(1))
      endif
...
c... denominators
     ...
     -     dcmplx((-2*E1J*E2J - 2*E1J*EvJ + 2*E2J*EvJ - 2*kJ**2 + 
     -      4*CW*kJ*kv + MB**2 + Mf**2 + Mff**2 - 4*Msf**2)/4.,
     -     Msf*width(sf)/mx*0d0))

      amp(0, 0) = amp(0, 0) + 2*(
     - ((0,0.25)*(2*CISR3*(2*E1J*Epl*kv - Emi*kv*Mf + Emi*kv*Mff + 
     - CW*EvJ*(-2*Epl*kJ - Mf*pmi + Mff*pmi) + CW*MB**2*ppl) + 
     - 2*CISR6*(2*E1J*Epl*kv - Emi*kv*Mf + Emi*kv*Mff + 
     -  CW*EvJ*(-2*Epl*kJ - Mf*pmi + Mff*pmi) + CW*MB**2*ppl) + 
     ...
     - 2*CISR3*(kv*(Mf + Mff)*pmi - 2*E1J*kv*ppl + 
     -    CW*(-(Epl*MB**2) + EvJ*(Emi*(Mf + Mff) + 2*kJ*ppl))) + 
     - 2*CISR6*(kv*(Mf + Mff)*pmi - 2*E1J*kv*ppl + 
     -    CW*(-(Epl*MB**2) + EvJ*(Emi*(Mf + Mff) + 2*kJ*ppl))) - 
     ...
     -  EvJ*(-((CISR2 - CISR7)*Epl*(Mf + Mff)) + 
     -  (CISR2 + CISR7)*(Mf - Mff)*ppl + 2*CISR4*(-Epl + ppl) + 
     -  2*CISR5*(Epl + ppl)))*Mkcha))/(4.*Sqrt(2.)*MB)
     - )/delta
     ...
     - )/delta
      ...
      amp(1, 2) = amp(1, 2) + 2*(
     - (SW*(CISR8*(Emi*(-2*(E1J*(E1J + E2J) + 
     - (E1J - E2J)*EvJ) + MB**2 + Mf**2 - 
     - Mff**2) + 2*Epl*(EvJ*(Mf - Mff) + kv*(Mf + Mff)) - 4*EvJ*kJ*pmi
     - ) + CISR1*(Emi*(2*E1J*(E1J + E2J) + 
     - 2*(E1J - E2J)*EvJ - MB**2 - Mf**2 + 
     ...
     -  CISR1*Epl*Mff**2 + CISR8*Epl*Mff**2 - 2*CISR1*kv*Mf*pmi + 
     - 2*CISR8*kv*Mf*pmi + 2*CISR1*kv*Mff*pmi - 2*CISR8*kv*Mff*pmi + 
     - 2*CISR3*EvJ*(Emi + pmi) - 2*CISR1*E1J**2*ppl 
     -  - 2*CISR8*E1J**2*ppl - 
     - 2*CISR1*E1J*E2J*ppl - 2*CISR8*E1J*E2J*ppl - 4*CISR1*kJ*kv*ppl - 
     - 4*CISR8*kJ*kv*ppl + CISR1*MB**2*ppl + CISR8*MB**2*ppl + 
     -  CISR1*Mf**2*ppl + CISR8*Mf**2*ppl - CISR1*Mff**2*ppl - 
     -  CISR8*Mff**2*ppl - 2*CISR3*
     - (Epl*(Mf + Mff) + kv*(Emi + pmi) + Mf*ppl - Mff*ppl) + 
     - 2*CISR6*(Epl*(Mf + Mff) - (EvJ + kv)*
     -  (Emi - pmi) - Mf*ppl + Mff*ppl) + 
     ...
     - )/delta
      ...
      amp(-1, 2) = amp(-1, 2) + 2*(
     - (SW*(CISR1*(Emi*(2*E1J*(E1J + E2J) 
     - + 2*(E1J - E2J)*EvJ - MB**2 - Mf**2 + 
     - Mff**2) - 2*Epl*(EvJ*(Mf - Mff) 
     - + kv*(Mf + Mff)) + 4*EvJ*kJ*pmi
     - ) - CISR8*(Emi*(2*E1J*(E1J + E2J)
     - + 2*(E1J - E2J)*EvJ - MB**2 - Mf**2 + 
     - Mff**2) + 2*(Epl*kv*(Mf + Mff) + 
     - EvJ*(Epl*(-Mf + Mff) + 2*kJ*pmi))) - 
     - 2*CISR6*(Epl*(-EvJ + kv) + Emi*(Mf + Mff) + 2*kJ*ppl) + 
     ...
     -  CISR1*(Emi*(Mf - Mff) + (Mf + Mff)*pmi - 
     -  (E1J - E2J)*(Epl + ppl))) + 
     - 2*(-(CISR2*EvJ*Emi) + CISR7*EvJ*Emi
     -  + CISR2*Emi*kv + CISR7*Emi*kv - 
     -  CISR2*Epl*Mf + CISR7*Epl*Mf - CISR2*Epl*Mff + CISR7*Epl*Mff + 
     -  CISR2*EvJ*pmi + CISR7*EvJ*pmi - CISR2*kv*pmi + CISR7*kv*pmi + 
     -  CISR2*Mf*ppl + CISR7*Mf*ppl - CISR2*Mff*ppl - CISR7*Mff*ppl + 
