...
c... couplings
c... H3
      CH31 = Conjg(gr(kh3,kn(ineu),kn(1)))**2*gr(kh3,f,f)
      CH32 = gr(kh3,f,f)*gr(kh3,kn(ineu),kn(1))**2

c... Hk
      do i = 1,2
         CHk1(i) = Conjg(gr(kh(i),kn(ineu),kn(1)))*
     -        gr(kh3,kn(ineu),kn(1))*gr(kh(i),f,f) 
         CHk2(i) =Conjg(gr(kh3,kn(ineu),kn(1)))*
     -        Conjg(gr(kh(i),kn(ineu),kn(1)))*gr(kh(i),f,f)
         CHk3(i) =gr(kh3,kn(ineu),kn(1))*gr(kh(i),f,f)*
     -        gr(kh(i),kn(ineu),kn(1))
         CHk4(i) =Conjg(gr(kh3,kn(ineu),kn(1)))*gr(kh(i),f,f)*
     -        gr(kh(i),kn(ineu),kn(1))
      end do
c... Z
      CZ1 = Conjg(gr(kh3,kn(ineu),kn(1)))*gl(kz,f,f)*
     - gl(kz,kn(1),kn(ineu))
      CZ2  = gl(kz,f,f)*gl(kz,kn(1),kn(ineu))*gr(kh3,kn(ineu),kn(1))
      CZ3 = Conjg(gl(kz,kn(1),kn(ineu)))*Conjg(gr(kh3,kn(ineu),kn(1)))*
     - gl(kz,f,f)
      CZ4 = Conjg(gl(kz,kn(1),kn(ineu)))*gl(kz,f,f)*
     - gr(kh3,kn(ineu),kn(1))
      CZ5 = Conjg(gr(kh3,kn(ineu),kn(1)))*gl(kz,kn(1),kn(ineu))*
     - gr(kz,f,f)
      CZ6 = gl(kz,kn(1),kn(ineu))*gr(kz,f,f)*gr(kh3,kn(ineu),kn(1))
      CZ7 = Conjg(gl(kz,kn(1),kn(ineu)))*Conjg(gr(kh3,kn(ineu),kn(1)))*
     - gr(kz,f,f)
...
c... H3 only amp00 contribution
      ampH300 = 0.d0
      ampH300 = + 2*(
     -     (0,4)*(CH31 - CH32)*E1J*Mkn(ineu)/deltaH3)

c... Hk (sum over ih) only amp02 contribution
      ampHk02 = 0.d0
      do ih = 1,2
         ampHk02 = ampHk02 + 2*(
     -       (0,1)*kJ*((CHk1(ih) - CHk4(ih))*(-4*E1J**2 + MB**2) 
     -        + 4*(-CHk2(ih) + CHk3(ih))*Mkn(ineu))/deltaHk(ih))
      end do 
