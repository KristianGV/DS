...
c     at the scale of the msbar mass, i.e. mqmq, to the 
c     scale mscale
...
c     
      ...
      real*8 ans,x,cc,ccold,mu1,mu2,mk,dsralph34loop
      integer n1,n2,n,s,p
      real*8 beta0(3:6),b1(3:6),b2(3:6),b3(3:6),muh(4:6),
