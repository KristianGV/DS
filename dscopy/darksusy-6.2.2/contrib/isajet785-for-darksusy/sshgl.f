...
C     MSSM light Higgs h coupling strengths relative to SM
      COMMON /KPHGGS/ KPB,KPT,KPL,KPW,KPZ,KPGL,KPGM
      REAL KPB,KPT,KPL,KPW,KPZ,KPGL,KPGM
      SAVE /KPHGGS/
C
