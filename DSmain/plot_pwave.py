...
#MAJORANA
i,m_p,sig1_p,sig1_p_errp,sig1_p_errm =np.loadtxt('examples/aux/generic_wimp_oh2-planck-sigmav-pwave.dat',unpack=True,skiprows=7, usecols=range(0,5)) 

i_s,m_s,sig1_s,sig1_s_errp,sig1_s_errm =np.loadtxt('examples/aux/generic_wimp_oh2-planck-sigmav-swave.dat',unpack=True,skiprows=7, usecols=range(0,5)) 

#DIRAC
i,m_p_d,sig1_p_d,sig1_p_errp_d,sig1_p_errm_d =np.loadtxt('examples/aux/generic_wimp_oh2-planck-sigmav-pwave-dirac.dat',unpack=True,skiprows=7, usecols=range(0,5)) 

i_s,m_s_d,sig1_s_d,sig1_s_errp_d,sig1_s_errm_d =np.loadtxt('examples/aux/generic_wimp_oh2-planck-sigmav-swave-dirac.dat',unpack=True,skiprows=7, usecols=range(0,5)) 


#MAJORANA
i_c,m_c_p,sig1_c_p,sig1_c_errp_p,sig1_c_errm_p=np.loadtxt('examples/aux/thermal_sigmav_Majorana_SM_pwave.dat',unpack=True,skiprows=2, usecols=range(0,5)) 

i_c,m_c_s,sig1_c_s,sig1_c_errp_s,sig1_c_errm_s=np.loadtxt('examples/aux/thermal_sigmav_Majorana_SM_swave.dat',unpack=True,skiprows=2, usecols=range(0,5)) 

#DIRAC
i_c,m_c_p_d,sig1_c_p_d,sig1_c_errp_p_d,sig1_c_errm_p_d=np.loadtxt('examples/aux/thermal_sigmav_Dirac_SM_pwave.dat',unpack=True,skiprows=2, usecols=range(0,5)) 

i_c,m_c_s_d,sig1_c_s_d,sig1_c_errp_s_d,sig1_c_errm_s_d=np.loadtxt('examples/aux/thermal_sigmav_Dirac_SM_swave.dat',unpack=True,skiprows=2, usecols=range(0,5)) 
...
plt.fill_between(m_s,sig1_s+sig1_s_errm,sig1_s+sig1_s_errp,color='red',alpha=0.2)


plt.semilogx(m_c_s,sig1_c_s, label='s-wave correct',color='blue',linewidth=.7)
...
plt.xlabel('WIMP mass')
plt.ylabel(r'$\frac{|\langle\sigma v\rangle_{correct}-\langle\sigma v\rangle|}{\langle\sigma v\rangle_{correct}}$')
...
plt.fill_between(m_p,sig1_p+sig1_p_errm,sig1_p+sig1_p_errp,color='red',alpha=0.2)

plt.semilogx(m_c_p,sig1_c_p, label='p-wave correct',color='blue',linewidth=.7)
...
plt.fill_between(m_s_d,sig1_s_d+sig1_s_errm_d,sig1_s_d+sig1_s_errp_d,color='red',alpha=0.2)


plt.semilogx(m_c_s_d,sig1_c_s_d, label='s-wave correct',color='blue',linewidth=.7)
plt.semilogx(m_c_s_d,sig1_c_errp_s_d, color='blue',linewidth=.5)
plt.semilogx(m_c_s_d,sig1_c_errm_s_d, color='blue',linewidth=.5)
plt.fill_between(m_c_s_d,sig1_c_errm_s_d,sig1_c_errp_s_d,color='blue',alpha=0.2)
...
plt.fill_between(m_p_d,sig1_p_d+sig1_p_errm_d,sig1_p_d+sig1_p_errp_d,color='red',alpha=0.2)

plt.semilogx(m_c_p_d,sig1_c_p_d, label='p-wave correct',color='blue',linewidth=.7)
plt.semilogx(m_c_p_d,sig1_c_errp_p_d, color='blue',linewidth=.5)
plt.semilogx(m_c_p_d,sig1_c_errm_p_d, color='blue',linewidth=.5)
plt.fill_between(m_c_p_d,sig1_c_errm_p_d,sig1_c_errp_p_d,color='blue',alpha=0.2)
